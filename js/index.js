...
document.addEventListener("DOMContentLoaded", function () {
  ...
  xrPointsGeometry.setAttribute(
    "position",
    new THREE.Float32BufferAttribute(xrVertices, 3)
  );
  ...
  project1Geometry.setAttribute(
    "position",
    new THREE.Float32BufferAttribute(project1Vertices, 3)
  );
  ...
  for (let i = 0; i < 5; i++) {
    ...
    orbPositions.push(
      new THREE.Vector3(orb.position.x, orb.position.y, orb.position.z)
    );
  ...
  const footerSphere = new THREE.Mesh(
    footerSphereGeometry,
    footerSphereMaterial
  );
